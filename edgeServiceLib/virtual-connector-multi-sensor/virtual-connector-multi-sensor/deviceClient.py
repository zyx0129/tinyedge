    ...
    def initClient(self):
        ...
        def on_message_come(client, userdata, msg):
            ...
            try:
                ...
                return
            print("New message come: "+ str(msg.payload)+ " , dataTimestamp:"+str(timestamp) + " , arrivalTimestamp:"+str(nowTime)+  " , timeInterval:"+str(nowTime-float(timestamp)) +" , traceId:"+traceId)
